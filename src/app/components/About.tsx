...
function About() {
  return (
    <div
      id="about"
      className="about w-full h-screen text-gray-300"
    >
      <div className="flex flex-col justify-center items-center w-full h-full">
        <div className="max-w-[1000px] w-full grid grid-cols-3 gap-8 px-4">
          <div className="sm:text-right pb-8 pl-4 pt-10">
            <p className="text-4xl sm:text-5xl font-bold inline border-b-4 border-teal-600">
              About
            </p>
          </div>
        ...
        <div className="max-w-[1000px] w-full grid sm:grid-cols-3 gap-10 px-4">
          <div className="sm:text-right text-4xl sm:text-5xl font-bold pl-4">
          ...
          <div className="max-w-[1000px] w-full px-4 sm:col-span-2">
            <p className="text-lg sm:text-xl sm:text-left mb-10">
              ...
              freelance), Marketing Support, and Education,
              <br /> I bring a unique blend of technical expertise and
              communication skills, while continuing my passion for developing
              user-friendly web applications and teaching complex subjects like
